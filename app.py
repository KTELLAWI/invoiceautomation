...
def send_to_make(data):
    ...
    webhook_url = "https://hook.eu2.make.com/lw397pqe5t1c06pjya42h29v9dljr24d"
...
# 5. Streamlit app
def main():
    # content = convert_pdf_to_images("invoice-1105479.pdf")
    # content1= extract_text_from_img(content)
    # content = extract_content_from_url("invoice-1105479.pdf")
    # print(content)
    default_data_points = """{
    ...
    st.set_page_config(page_title="Documents extraction", page_icon=":rabbit:")

    st.header("Documents extraction :rabbit:")
    ...
    if uploaded_files is not None and data_points is not None:
        ...
        for file in uploaded_files:
            with NamedTemporaryFile(dir='.', suffix='.csv') as f:
                ...
                print(content1)
                data = extract_structured_data(content1, data_points)
